...
CREATE TABLE "Reaction" (
    ...
    CONSTRAINT "Reaction_pkey" PRIMARY KEY ("userId","messageId","emoji")
);
...
-- AddForeignKey
ALTER TABLE "ReadState" ADD CONSTRAINT "ReadState_lastMessageId_fkey" FOREIGN KEY ("lastMessageId") REFERENCES "Message"("id") ON DELETE CASCADE ON UPDATE CASCADE;
